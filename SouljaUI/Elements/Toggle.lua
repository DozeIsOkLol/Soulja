...
return function(parent, TextService, UserInputService, config)
    ...
    Button.MouseButton1Click:Connect(function() 
        ...
        local cColor = toggled and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(180, 180, 180); 
        local sColor = toggled and Color3.fromRGB(0, 122, 255) or Color3.fromRGB(30, 30, 30); 
