...
return function(SouljaUI, Elements)
    return function(config)
        ...
        function WindowMethods:CreateTab(name)
            ...
            local function SwitchToTab() for _, v in pairs(Properties.Tabs) do v.ContentFrame.Visible = false; TweenService:Create(v.Button, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(40, 40, 40), TextColor3 = Color3.fromRGB(200, 200, 200)}):Play() end; TabContent.Visible = true; TweenService:Create(TabButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0, 122, 255), TextColor3 = Color3.fromRGB(255, 255, 255)}):Play() end
